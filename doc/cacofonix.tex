...
First of all, the operator \lstinline!mtimes! (\lstinline!*!) works exactly like the operator \lstinline!.*! when it is used on a sheet and a number: the sheet is simply repated.
\begin{lstlisting}
>> Note.setNbCharByQuater(8)
>> 3*[ (G:N2)*2 bar ]
$1///////////////////////////////$
...
\begin{algo}{M}{Operator \lstinline!*!}{Given a \note \lstinline!n! and a sheet \lstinline!A! (which contains void notes), we compute \lstinline!B = n*A! with this algorithm:}
	...
	\step[checki]{Check \lstinline!i!.}{If \lstinline!i > length(A)!, stop the algortihm and return \lstinline!B!.}
...
VOICE = [ Note([4 4]) ...
	...
	F:N4' A:N8 +C:N2 bar ...
	+[ R D D D ].*N8 +C:N2 bar ...
	[ R Bf Bf Bf ].*N8 A:N2 bar ...
	[ R G G G ].*N8 F:N2 bar ];

RIFF = [ V-1 V-2 V-3 +V-1 V-3 V-2 ].*N12;
GUITAR = [ DynMP R:N4 bar ...
	F*CM*RIFF A*Cm*RIFF bar ...
	Bf*CM*RIFF A*Cm*RIFF bar ...
	G*Cm*RIFF F*CM*RIFF bar ...
	A*CM*RIFF D*Cm*RIFF bar ];

STRINGS = [ DynPP R:N4 bar ...
	F*CM:N2 A*Cm:N2 bar ...
	Bf*CM:N2 A*Cm:N2 bar ...
	G*Cm:N2 F*CM:N2 bar ...
	A*CM:N2 D*Cm:N2 bar ];

cacofonix( 'WhatAWonderfulWorld', 'Tempo', 70, ...
	'Bassoon', -VOICE, ...
	'Nylon-String Guitar', GUITAR, ...
