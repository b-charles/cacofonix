...
Sometimes, it can be useful to extract a piece of a sheet which has been already transcode (\eg to play something twice, or to add a coda\dots). This operation can be very complicated with polyphonic sections, so the operator \lstinline!or! (\lstinline!|!) realize neatly this function.
...
The \lstinline!display! function has been overloaded: it can be used to display a sheet
