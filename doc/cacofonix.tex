...
real pitchTransNone( real t ) { return ( t<t1) ? p0 : p1; }
...
\me{Who are the target customers? Who needs help to write midi files? Who thinks about \matlab to create a midi file? Who wakes up the morning and says ``Hoho! Today, I'm going to create a midi file. I think the easiest way is to use \matlab and an underground library.''?}
...
\begin{figure}
	\begin{center}
		\begin{subfloatenv}{Transition \lstinline!none!}
			\begin{asy}
...
f4\fermata\startTrillSpan\mf( f2) f4\stopTrillSpan \glissando
...
sheet = [ ...
	Note('fermata', N4, N4') tremolo -F:N2' pitch('0') ...
