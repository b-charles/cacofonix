...
\begin{algo}{M}{Operator \lstinline!*!}{Given a \note \lstinline!n! and a sheet \lstinline!A! (which contains void notes), we compute \lstinline!n*A! with this algorithm:}
	\step{Initialize.}{Set \lstinline!i = 1!.}
	\step[checki]{Check \lstinline!i!.}{If \lstinline!i > length(A)!, stop the algorithm and return the new \lstinline!A!.}
	\step{Set the tonality.}{If the \lstinline!i!th element of \lstinline!A! is a void note, set the tonality of \lstinline!A(i)! with the tonality of \lstinline!n!.}
...
\subsubsection{Transposed void notes}
