...
if isempty( INSTRUMENTS )
	...
	PERCUSSIONS = [ ...
		...
		struct( 'name', 'Hi Bongo',				'ton', [ 0 1 ] )
		struct( 'name', 'Low Bongo',			'ton', [ 1 0 ] )
		struct( 'name', 'Mute Hi Conga',		'ton', [ 2 3 4 ] )
		struct( 'name', 'Open Hi Conga',		'ton', [ 3 2 4 ] )
		struct( 'name', 'Low Conga',			'ton', [ 4 2 3 ] )
		struct( 'name', 'High Timbale',			'ton', [ 5 6 ] )
		struct( 'name', 'Low Timbale',			'ton', [ 6 5 ] )
		struct( 'name', 'High Agogo',			'ton', [ 7 8 ] )
		struct( 'name', 'Low Agogo',			'ton', [ 8 7 ] )
		...
		struct( 'name', 'Hi Wood Block',		'ton', [ 16 17 ] )
		struct( 'name', 'Low Wood Block',		'ton', [ 17 16 ] )
