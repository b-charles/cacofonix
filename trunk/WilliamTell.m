...
MARK226 = Note( 'Marker', '#226#' ); goMARK226 = Note( 'Marker*', '#226#' );
MARK234 = Note( 'Marker', '#234#' ); goMARK234 = Note( 'Marker*', '#234#' );
MARK243 = Note( 'Marker', '#243#' ); goMARK243 = Note( 'Marker*', '#243#' );
MARK250 = Note( 'Marker', '#250#' ); goMARK250 = Note( 'Marker*', '#250#' );
MARK256 = Note( 'Marker', '#256#' ); goMARK256 = Note( 'Marker*', '#256#' );
MARK264 = Note( 'Marker', '#264#' ); goMARK264 = Note( 'Marker*', '#264#' );
MARK272 = Note( 'Marker', '#272#' ); goMARK272 = Note( 'Marker*', '#272#' );
MARK280 = Note( 'Marker', '#280#' ); goMARK280 = Note( 'Marker*', '#280#' );
MARK286 = Note( 'Marker', '#286#' ); goMARK286 = Note( 'Marker*', '#286#' );
MARK291 = Note( 'Marker', '#291#' ); goMARK291 = Note( 'Marker*', '#291#' );
MARK300 = Note( 'Marker', '#300#' ); goMARK300 = Note( 'Marker*', '#300#' );
