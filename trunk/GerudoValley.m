...
MarkerB = Note( 'Marker', 'B' ); goMarkerB = Note( 'Marker*', 'B' );
MarkerC = Note( 'Marker', 'C' );
MarkerD = Note( 'Marker', 'D' );
MarkerE = Note( 'Marker', 'E' ); goMarkerE = Note( 'Marker*', 'E' );
MarkerF = Note( 'Marker', 'F' ); goMarkerF = Note( 'Marker*', 'F' );

MarkerEND = Note( 'Marker', 'END' ); goMarkerEND = Note( 'Marker*', 'END' );
...
TROMBONE = [ goMarkerB goMarkerEND goMarkerE PAUSE*8 ...
