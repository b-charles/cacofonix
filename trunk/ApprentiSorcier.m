...
MARK1  = Note( 'Marker', '#1#' );  goMARK1  = Note( 'Marker*', '#1#' );
MARK1_ = Note( 'Marker', '#1_#' ); goMARK1_ = Note( 'Marker*', '#1_#' );
MARK2  = Note( 'Marker', '#2#' );  goMARK2  = Note( 'Marker*', '#2#' );
...
CORS12 = [ ...
goMARK1_ Note('+0') re++do:'.':D S:D S:D S:C' S:C' bar ...
S:C' S:C' S:C' bar ...
S:C' S:C' S:C' bar ...
MARK2 ...
];
...
CORS34 = [ ...
goMARK1_ Note('+0') la++faD:'.':D S:D S:D S:C' S:C' bar ...
S:C' S:C' S:C' bar ...
S:C' S:C' S:C' bar ...
MARK2 ...
];
...
TROMPETTES = [ ...
goMARK2 Note('+0') DynpF laB:'.':D S:D S:D +miB:'.':D S:D S:D miB:'.':D fa:'.':D sol:'.':D bar ...
